        ...
        <div class="card-body shadow">
            ...
            <div class="form-floating mb-3">
                <select name="sim_card" class="form-select" wire:model.defer="sim_card">
                    ...
                    <option value="Team Manila">Team Manila</option>
                    <option value="The Daily Grind">The Daily Grind</option>
                    <option value="Skoop">Skoop</option>
                    <option value="Trashers">Trashers</option>
                    <option value="Medisina">Medisina</option>
                    <option value="Drone Clothing">Drone Clothing</option>
                </select>
